...
1. В самом начале нужно увеличить виртуальную память, для развёртки ElasticSearch
   
```{yml}
sysctl -w vm.max_map_count=262144
```

2. Создадим файл .env, в котором будут лежать пароли, версию, порты и т.д.
...
4. Добавим средства сбора информации из файлов журналов Filebeat
...
5. Добавим средства сбора сетевого трафика Packetbeat
...
## Вывод
В результате выполненной работы были развёрнута поисковая система ElasticSearch и прозведена настройка системы сбора трафика и логов.
Были освоены приложения для работы с контейнеризации приложений - Docker, Docker-compose и поисковая система ElasticSearch